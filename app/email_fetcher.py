...
# Configure logging
logging.basicConfig(filename='email_fetcher.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def fetch_and_summarize_emails():
    try:
        ...
        logging.info('Email fetching and summarization completed successfully.')
